...
import 'package:lanka_explorer/presentation/screens/home/my_trip.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  mainAxisSize: MainAxisSize.min, // Keeps the buttons together
  children: [
    FloatingActionButton.extended(
      heroTag: 'mytrip_btn', // Unique tag required for multiple FABs
      onPressed: () {
        Navigator.push(
          context,
    ...
    FloatingActionButton.extended(
      heroTag: 'plan_trip_btn', // Unique tag required for multiple FABs
      onPressed: () {
        Navigator.push(
          context,
